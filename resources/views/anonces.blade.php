            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3  border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:text-white lg:dark:hover:bg-transparent">contact</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3  border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:text-white lg:dark:hover:bg-transparent">anonces</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:text-white lg:dark:hover:bg-transparent">projects</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="max-w-sm w-full  py-6 px-3">
                <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <h2 class="uppercase tracking-wide text-xl font-bold text-gray-900">{{ $house->type }} {{ $house->size }}m2</h2>
                    ...
                    <div class="flex p-4 border-t border-gray-300 text-gray-700">
                        ...
                        <div class="flex-1 inline-flex items-center">
                            ...
                            <p><span class="text-gray-900 font-bold">{{ $house->bedrooms }}</span> Bedrooms</p>
                        </div>
                        <div class="flex-1 inline-flex items-center">
                            <svg class="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p><span class="text-gray-900 font-bold">{{ $house->bathrooms }}</span> Bathrooms</p>
                        </div>
