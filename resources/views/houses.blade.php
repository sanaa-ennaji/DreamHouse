...
<body class="bg-gray-200">
            ...
            <button type="button" class="mt-20 mr-20 flex items-center">
                <div class="flex-shrink-0 w-10 h-10 relative">
                    <div class="p-1 bg-white rounded-full focus:outline-none focus:ring">
                        <img class="w-10 h-8 rounded-full" src="{{ asset('storage/img/' . auth()->user()->profile) }}"
                            alt="user photo" />
    ...
    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" id="btn"
        class="relative block text-white bg-[#FFD700] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button">
        add new house
    </button>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                aria-describedby="file_input_help" name="images[]" id="images" multiple
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr
                        ...
                        <th scope="col" class="px-6 py-3 text-red">
                          <a href="#"
                          class="font-medium text-red-600 dark:text-blue-500 hover:underline"><form action="{{ route('houses.destroy', ['id' => $house->id]) }}" method="post">
                            @csrf
                            @method('DELETE')
